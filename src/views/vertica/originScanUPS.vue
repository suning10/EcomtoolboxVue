<template>
    ...
    <div class="addBrand-container">
      <h2 style="text-align: center; margin-bottom: 10px;">Origin Scan UPS</h2>
        <div class="container">
            <el-form ref="form" :model="ruleform " label-width="240px" v-if="!displayResult">
              ...
              <el-form-item>
                  <el-button type="primary" @click="upsSearch" :loading = loader>Search</el-button>
              </el-form-item>
              ...
              style="width: 100%">
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <a :href = "'https://www.ups.com/track?loc=en_US&tracknum=' + scope.row.tracking + '&requester=ST/trackdetails'" target="_blank" style="color: blue; text-decoration: underline;">
                      {{ scope.row.tracking }}
                    </a>
                  </template>
                </el-table-column>
